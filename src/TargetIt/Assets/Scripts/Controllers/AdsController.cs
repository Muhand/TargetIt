...
public class AdsController : MonoBehaviour {
	...
	public InterstitialAd getInterstitialView {
		get
		{
			return interstitial;
		}
	...
	void Start()
	{
		...
		#elif UNITY_IPHONE
			string appId = "ca-app-pub-4660233401396733~3844466509";
		#else
	...
	public void RequestBanner()
	{
		...
		#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-4660233401396733/3525026019";
		#else
	...
	public void RequestInterstitial()
	{
		...
		#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-4660233401396733/3155039083";
		#else
		string adUnitId = "unexpected_platform";
		#endif
